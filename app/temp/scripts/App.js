            ...
            this.itemsToReveal.each(function () {
                ...
                new Waypoint({ //создаем обьект
                    ...
                    handler: function handler() {
                        (0, _jquery2.default)(currentItem).addClass('reveal-item--is-visible'); //делаем его видимым
                    },
    ...
    _createClass(StickyHeader, [{
        ...
        value: function refreshWaypoints() {
            this.lazyImages.load(function () {
                Waypoint.refreshAll(); //refresh all waypoints in all modules
            });
        }
    }, {
        ...
        value: function createHeaderWaypoint() {
            var that = this;
            new Waypoint({
                element: this.headerTriggerElement[0], //дойдя до єтого елемента
                handler: function handler(direction) {
                    if (direction == 'down') {
                        //еслі прокрутка вніз
                        that.siteHeader.addClass('site-header--dark'); //затемняем
                    } else {
                        //еслі вверх
                        that.siteHeader.removeClass('site-header--dark'); //осветляем
                    }
                }
            });
        }
